...
{
    public:
        TreeNode():lson_(NULL),rson_(NULL),freq(1),hgt(0){}
        T data;
        int hgt;
        unsigned int freq;
        TreeNode<T> *lson_;
...
class Tree
{
    ...
    private:
        ...
        void SingRotateLR(TreeNode<T> *&k3);
        void SingRotateRL(TreeNode<T> *&k3);
